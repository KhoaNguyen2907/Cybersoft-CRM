...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<c:url value =" /style/plugins/images/favicon.png"/>">
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                    <a href="roleModel-add.html" class="btn btn-sm btn-success">Thêm mới</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /row -->
